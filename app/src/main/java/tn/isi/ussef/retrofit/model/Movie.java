...
public class Movie {
    ...
    private List<Countrie> countries = new ArrayList<Countrie>();
    @SerializedName("id")
    private Integer id;
    ...
    public Movie(String posterPath, boolean adult, String overview, String releaseDate,
                 List<Genre> genres, List<Companie> companies, List<Countrie> countries,
                 Integer id, String originalTitle, String originalLanguage, String title,
                 String backdropPath, Double popularity, Integer voteCount, Integer runtime,
    ...
    public void setCountries(List<Countrie> countries) {
        this.countries = countries;
    }
}
